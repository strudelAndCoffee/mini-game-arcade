...
function startGame() {
  ...
  if (dealer_sum - face_down.val > 21) endGame()
...
function endGame() {
  ...
  let msg = ''
  if (your_sum > 21 || (your_sum < dealer_sum && dealer_sum <= 21))
    msg = 'You lose.'
  else if (dealer_sum > 21 || (your_sum > dealer_sum && your_sum <= 21))
    msg = 'You win!'
  ...
  hitBtnEl.classList.add('hide')
  stayBtnEl.classList.add('hide')
}
